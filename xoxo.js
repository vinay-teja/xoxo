...
//boardSizeNum = parseInt(DOM.boardSizeInput.value);
...
var N_SIZE = prompt("Please enter Size of the game you wanted to play.", "Hint: Enter number >2"),
EMPTY = '&nbsp;',
  boxes = [],
  turn = 'X',
  score,
...
function set() {
  ...
  if (win(this)) {
    ...
    alert('Your game is draw, hit reset');
    startNewGame();
  } else {
    turn = turn === 'X' ? 'O' : 'X';
